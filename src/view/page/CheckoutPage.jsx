...
export const CheckoutPage = () => {
  ...
  if (success) {
    ...
    const totalPaid = (lastTransactionTotal ?? cartTotal).toLocaleString(
      'es-CO'
    );
      ...
      <Box sx={{ minHeight: '100vh', bgcolor: CHECKOUT_BG }}>
        ...
        >
          ...
          >
            ...
            >
              Tu transacción se procesó correctamente. Hemos enviado los
              detalles de tu pedido a tu correo electrónico.
            </Typography>
            ...
            <Button
              ...
              sx={{
                ...
                '&:hover': {
                  bgcolor: CHECKOUT_PRIMARY_HOVER,
                  boxShadow: `0 4px 14px ${CHECKOUT_PRIMARY}4D`,
                },
              }}
            >
              Volver a productos
  ...
  return (
    <Box
      sx={{ minHeight: '100vh', bgcolor: CHECKOUT_BG, color: 'text.primary' }}
    >
      <Box
        component="header"
        sx={{
      ...
      <Box component="main" sx={{ maxWidth: 1280, mx: 'auto', px: 3, py: 6 }}>
        ...
        >
              ...
              <Box>
                ...
                >
                  ...
                  >
                    <Box>
                      ...
                      <TextField
                        ...
                        onChange={handleCardChange('card_holder')}
                        required
                        inputProps={{
                          style: {
                            textTransform: 'uppercase',
                    ...
                    <Box>
                      ...
                      <TextField
                        ...
                        sx={[inputSx, { '& .MuiInputBase-input': { pr: 10 } }]}
                      />
                    </Box>
                    <Box
                      sx={{
                        ...
                        <TextField
                          ...
                          onChange={(e) => {
                            ...
                            if (v.length <= 2)
                              ...
                              setCard((p) => ({
                                ...p,
                                exp_month: v.slice(0, 2),
                                exp_year: v.slice(2, 4),
                              }));
                          }}
                          sx={inputSx}
                        />
                  ...
                  >
                    ...
                    >
                      Tus datos de pago se cifran con tecnología SSL. No
                      guardamos tu CVV ni datos sensibles de la tarjeta.
                    </Typography>
                  </Box>
                </Box>
              </Box>
          ...
          >
            ...
            >
              <Typography sx={{ fontSize: '1.125rem', fontWeight: 700, mb: 3 }}>
                Resumen del pedido
              </Typography>
              <Box
              ...
              >
                ...
                <Box>
                  <Typography variant="body2">Impuesto estimado</Typography>
                  <Typography variant="body2">
            ...
            >
              Al hacer clic en "Completar compra" aceptas nuestros Términos de
